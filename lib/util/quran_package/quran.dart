import 'dart:math';
import 'package:quran_app/util/quran_package/quran_text_normal.dart';
import 'package:quran_app/util/quran_package/reciters.dart';
...
String getPlaceOfRevelation(int surahNumber) {
  ...
  return surah[surahNumber - 1]['arPlace'].toString();
}
